...
public class HomeForm extends Form {
    ...
    private static final String ADD_BUTTON_TEXT = "Ajouter Annonce";
    private static final String LIST_BUTTON_TEXT = "Afficher Les annonces";
    ...
    public HomeForm() {
        ...
        addButton.setText("Ajouter Reclamation");
        addButton.addActionListener(e -> new AjoutReclamationForm(this).show());

        Button listButton = new Button("");
        listButton.setIcon(FontImage.createMaterial(LIST_ICON_NAME, UIManager.getInstance().getComponentStyle("Button")));
        listButton.setText("Afficher Les reclamation");
