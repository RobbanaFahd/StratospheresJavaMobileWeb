      ...
      // TextField tfuser = new TextField("","user ");
        ...
        btnValider.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                //String uString = tfuser.getText(); 
                int telInt = Integer.parseInt(telString);
                //int uInt = Integer.parseInt(uString);
                ...
                else
                {
                    try {
                        ...
                        if( ServiceAnnonce.getInstance().addAnnonce(t)) {
        ...
        addAll(tfnom ,tfimage,tdescreption,tftitre ,tftel ,tfemail,tflocal,tfetat,tfcategorie,btnValider);
