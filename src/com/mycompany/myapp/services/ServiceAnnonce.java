...
//ajout
    public boolean ajoutAnnonce(Annonce annonce) {
       ...
       // String url = Statics.Base_URL + "/aaddjson?nom=" + annonce.getNom() + "&image=" + annonce.getImage() + "&descreption=" + annonce.getDescreption() + "&titre=" + annonce.getTitre() + "&tel=" + annonce.getTel() + "&=email" + annonce.getEmail() + "&local=" + annonce.getLocal() + "&etat=" + annonce.getEtat() + "&catégorie=" + annonce.getCategorie();
      //    String url = "http://127.0.0.1:8000/" +"annonce/ajouteM?id="+annonce.getId()+"&user_id="+annonce.getUser_id()+"&nom="+annonce.getNom()+"&image="+annonce.getImage()+"&descreption="+annonce.getDescreption()+"&titre="+ annonce.getTitre()+"&tel="+annonce.getTel()+"&email="+annonce.getEmail()+"&local="+annonce.getLocal()+"&etat="+annonce.getEtat()+"&catégorie="+annonce.getCategorie();
 
      // String url = "http://127.0.0.1:8000/" +"aaddjson?nom="+annonce.getNom()+"&image="+annonce.getImage()+"&descreption="+annonce.getDescreption()+"&titre="+ annonce.getTitre()+"&tel="+annonce.getTel()+"&email="+annonce.getEmail()+"&local="+annonce.getLocal()+"&etat="+annonce.getEtat()+"&catégorie="+annonce.getCategorie();
 String url = "http://127.0.0.1:8000/annonce/ajouteM?nom="+annonce.getNom()+"&image="+annonce.getImage()+"&descreption="+annonce.getDescreption()+"&titre="+ annonce.getTitre()+"&tel="+annonce.getTel()+"&email="+annonce.getEmail()+"&local="+annonce.getLocal()+"&etat="+annonce.getEtat()+"&catégorie="+annonce.getCategorie();
 //this//String url = "http://127.0.0.1:8000/"+ "annonce/ajouteM?nom="+annonce.getNom()+"&image="+annonce.getImage()+"&descreption="+annonce.getDescreption()+"&titre="+ annonce.getTitre()+"&tel="+annonce.getTel()+"&email="+annonce.getEmail()+"&local="+annonce.getLocal()+"&etat="+annonce.getEtat()+"&catégorie="+annonce.getCategorie();
 
      //    String url = "http://127.0.0.1:8000/" + "annonce/ajouteM?user_id="+annonce.getUser_id()+"&nom="+annonce.getNom()+"&image="+annonce.getImage()+"&descreption="+annonce.getDescreption()+"&titre="+ annonce.getTitre()+"&email="+annonce.getEmail()+"&local="+annonce.getLocal()+"&etat="+annonce.getEtat()+"&catégorie="+annonce.getCategorie();
...
String url= "http://127.0.0.1:8000/"+"aaddjson?nom="+nom+" &image="+image+" &descreption="+descreption+" &titre=" +titre+" &email="+email+" &local="+local+" &etat=" +etat+" &cat=" +cat;
        req.setUrl(url);
        req.setPost(false);
