...
public class Annonce {
    ...
    private String nom,image , descreption,titre ;
     private int tel ;
    ...
    public Annonce(int user_id, String nom, String image, String descreption, String titre, String email, String local, String etat, String categorie) {
        this.user_id = user_id;
        this.nom = nom;
        this.image = image;
        this.descreption = descreption;
    ...
    public Annonce(String nom, String descreption, String titre) {
        this.nom = nom;
        this.descreption = descreption;
        this.titre = titre;
    }
